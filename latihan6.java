public class latihan6 {
	public static void main(String args []) {
		...
		switch(hurufAwal){
			...
			case 'c' : System.out.println ("apa namamu ceceo ?"); break;		//jika salah satu break dihapus dibagian c maka peryataan yang dibawahnya yaitu pada bagian d akan ikut tampil dalam outputnya
